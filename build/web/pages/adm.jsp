<%-- 
    Document   : adm
    Created on : 06/03/2020, 14:47:32
    Author     : simon
--%>
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                <li>
                                    <a href="estoque.html" class="d-flex">
                                        <p>Gerenciar Estoque</p>
                                        
                                    </a>
                                </li>
                                <li>
                                    <a href="cadastroprod.html" class="d-flex">
                                ...
                                <li>
                                    <a href="gerenciarcli.html" class="d-flex">
                                        <p>Gerenciar Clientes</p>
                                        
                                    </a>
                                </li>
                                <li>
                                    <a href="gerenciarped.html" class="d-flex">
                                        <p> Gerenciar Pedidos </p>
                                        
                                    </a>
                                </li>
                                <li>
                                    <a href="adm_relatorios.html" class="d-flex">
                                        <p> Relatórios </p>
