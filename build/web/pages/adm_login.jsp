<%-- 
    Document   : adm_login
    Created on : 06/03/2020, 14:49:46
    Author     : simon
--%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="breadcrumb_iner">
                            <h2>login do administrador loja</h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                <h3> Por favor digite seus dados</h3>
                                <form class="row contact_form" action="adm.html" method="post" novalidate="novalidate">
                                    ...
                                    <div class="col-md-12 form-group">
                                        <div class="creat_account d-flex align-items-center">
                                            ...
                                            <label for="f-option">lembrar dados</label>
                                        </div>
