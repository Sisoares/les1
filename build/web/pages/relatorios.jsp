<%-- 
    Document   : relatorios
    Created on : 06/03/2020, 15:04:07
    Author     : simon
--%>
        ...
        <div class="col-lg-4">
            <div class="blog_right_sidebar">
                <aside class="single_sidebar_widget search_widget">
                    ...
                    type="submit">Cliente</radio_button_checked>
                    <radio_button_checked class="button rounded-0 primary-bg text-white w-100 btn_1"
                    type="submit">Pedidos</radio_button_checked>
                    <radio_button_checked class="button rounded-0 primary-bg text-white w-100 btn_1"
                    type="submit">Vendas</radio_button_checked>
                    <radio_button_checked class="button rounded-0 primary-bg text-white w-100 btn_1"
                    type="submit">Estoque</radio_button_checked>
                    <radio_button_checked class="button rounded-0 primary-bg text-white w-100 btn_1"
                    type="submit">Produtos</radio_button_checked>
                    </a>
                </aside>
             </div>
         </div>
                  ...
                  <div class="form-group">
                      <div class="input-group mb-3">
                          <input type="date" class="form-control" placeholder='Data inicial'
                              ...
                              onblur="this.placeholder = 'Data inicial'">
                          

                          <input type="date" class="form-control" placeholder='Data final'
                              onfocus="this.placeholder = ''"
                              onblur="this.placeholder = 'Data final'">
                         
                      </div>
                  </div>
                  <button class="button rounded-0 primary-bg text-white w-100 btn_1"
                      type="submit">Gerar relatório</button>
              </form>
            </aside>
        </div>
    </div>
