<%-- 
    ...
    Created on : 06/03/2020, 14:52:16
    Author     : simon
--%>
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb_iner">
                        <h2>Gerenciar Produtos em estoque</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
     ...
     <!--- <ul class="list cat-list">
        <li>-->
            <form action="cadastroestoque.html" method="POST">
            <div class="col-lg-4">
                <div class="blog_right_sidebar">
                    <aside class="single_sidebar_widget search_widget">
                <a href="#" class="d-flex">
    ...
    <form action="relatorios.html" method="POST">
        <div class="col-lg-8">
            <div class="blog_right_sidebar">
                <aside class="single_sidebar_widget search_widget">
            <a href="#" class="d-flex">
            <button class="button rounded-0 primary-bg text-white w-100 btn_1"
            type="submit">Relatórios</button>
    </form>
