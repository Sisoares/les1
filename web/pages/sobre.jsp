<%-- 
    Document   : sobre
    Created on : 06/03/2020, 15:04:30
    Author     : simon
--%>
...
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="about_us_content">
                        ...
                        <h3> 
                            Artesanatos da Ana Ateliê é uma loja especializada em varias técnicas
                            de artesanato, tudo feito com dedicação, carinho e capricho, são produtos
                            exclusivos como todo artesanato feito a mão. 
                            </h3>
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    <div class="feature_part_tittle">
                        <h3>Fique a vontade para navegar em nosso site e conhecer nossos artesanatos.</h3>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        ...
                        <h4>Aceitamos cartão de crédito</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
                        <img src="img/icon/feature_icon_2.svg" alt="#">
                        <h4>Emitimos Boletos</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_feature_part">
    ...
    <div>
        <center>
        <img src="img/logoret.jpg" align="middle">
    </center>
    </div>
