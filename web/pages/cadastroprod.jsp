<%-- 
    ...
    Created on : 06/03/2020, 14:50:40
    Author     : simon
--%>
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="produto.html" id="navbarDropdown_1"
    ...
    <div class="container">
       <div class="billing_details">
            <div class="row">
              <div class="col-lg-8">
                <h3>Dados produto</h3>
                <form class="row contact_form" action="gerenciarprod.html" method="post" novalidate="novalidate">
                  <div class="col-md-6 form-group p_star">
                    <input type="text" class="form-control" id="first" name="name" />
                    <span class="placeholder" data-placeholder="Nome do produto"></span>
                  </div>
                  
                  <div class="col-md-6 form-group p_star">
                    <input type="text" class="form-control" id="" name="img" />
                    <span class="placeholder" data-placeholder="imagem"></span>
                  </div>

                  <div class="col-md-6 form-group p_star">
                    <input type="text" class="form-control" id="" name="descricao" />
                    <span class="placeholder" data-placeholder="Descrição"></span>
                  </div>
                 
                  <div class="col-md-6 form-group p_star">
                    <input type="text" class="form-control" id="" name="preço" />
                    <span class="placeholder" data-placeholder="Preço"></span>
                  </div>

                  
                      <button type="submit"  value="salvar" class="btn_3">
                        Salvar
                    </button>
                    <button type="submit"  value="voltar" class="btn_3">
                        Voltar
                    </button>
                  </div>         
          </div>
                  ...
                  <div class="col-lg-8">
                      <div class="footer_menu">
                          ...
                          <div class="footer_menu_item">
                              ...
                              <a href="sobre.html.html">Sobre</a>
