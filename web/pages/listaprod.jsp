<%-- 
    Document   : listaprod
    Created on : 06/03/2020, 15:02:56
    Author     : simon
--%>
                ...
                <div class="col-md-4">
                    <div class="product_sidebar">
                        <div class="single_sedebar">
                            <form action="#">
                                <input type="text" name="#" placeholder="Digite o que produra">
                                <i class="ti-search"></i>
                            </form>
                        </div>
                        <div class="single_sedebar">
                        ...
                        <div class="single_sedebar">
                            <div class="select_option">
                                <div class="select_option_list">Tipo <i class="right fas fa-caret-down"></i> </div>
                                <div class="select_option_dropdown">
                                    <p><a href="#">Tipo 1</a></p>
                                    <p><a href="#">Tipo 2</a></p>
                                    <p><a href="#">Tipo 3</a></p>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="img/product/caderno_decorado.jpg" alt="#" class="img-fluid">
                                    <h3> <a href="produto.html">Caderno decorado personalizado</a> </h3>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="img/product/bolsa_tiracolo.jpg" alt="#" class="img-fluid">
                                        <h3> <a href="produto.html">Bolsa tiracolo</a> </h3>
                                <p>a partir de  R$50,00</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="img/product/chinelo1.jpg" alt="#" class="img-fluid">
                        <h3> <a href="produto.html">Chinelos enfeitados</a> </h3>
                        <p>a partir de  R$30,00</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="img/product/toalha_bordada.jpg" alt="#" class="img-fluid">
                        <h3> <a href="produto.html">Toalhas bordadas</a> </h3>
                        <p>à partir de R$20,00</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="img/product/bolsa_outono.jpg" alt="#" class="img-fluid">
                        <h3> <a href="produto.html">Bolsa estação outono</a> </h3>
                        <p>a partir de R$50,00</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="img/product/toalha_ovelha.jpg" alt="#" class="img-fluid">
                        <h3> <a href="produto.html">Toalha bordada</a> </h3>
                        <p>à partir de R$20,00</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="produto.html">Memory foam filling cotton Slow rebound pillows</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="produto.html">Sleeping orthopedic sciatica Back Hip Joint Pain relief</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="produto.html">Geometric striped flower home classy decor</a> </h3>
                                    <p>From $5</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="subscribe_part_content">
                    ...
                    <p>Prometemos que não vamos encher sua caixa de e-mails!</p>
