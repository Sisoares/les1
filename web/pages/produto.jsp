<%-- 
    Document   : produto
    Created on : 06/03/2020, 15:03:47
    Author     : simon
--%>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="product_img_slide owl-carousel">
            <div class="single_product_img">
              <img src="img/product/cadernos_decorados.jpg" alt="#" class="img-fluid">
            </div>
            <div class="single_product_img">
              <img src="img/product/cadernos_decorados.jpg" alt="#" class="img-fluid">
            </div>
        ...
        <div class="col-lg-8">
          <div class="single_product_text text-center">
            <h3>Deixe seus materiais com a sua cara! </h3><br>
                <h2>Lindos Cadernos decorados</h2>
            <p>
                Feito com tecido 100% algodão, essas capas além de protegerem seu material, dão todo o charme 
                que só um produto feito com carinho e personalizado como um bom artesanato pode oferecer!
            </p>
            <div class="card_area">
              ...
              <div class="add_to_cart">
                  <a href="carrinho.html" class="btn_3">Adicionar ao carrinho</a>
              </div>
            </div>
          </div>
        </div>
