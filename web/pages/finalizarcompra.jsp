<%-- 
    ...
    Created on : 06/03/2020, 14:51:42
    Author     : simon
--%>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="confirmation_tittle">
            <span>Dados das ultimas compras</span>
          </div>
        </div>
        ...
        <div>
                  ...
                  <div class="blog_right_sidebar">
                      <aside class="single_sidebar_widget">
                          <a href="comprafinalizada.html" class="d-flex">
                          <button type="submit" class="button rounded-0 primary-bg text-white w-100 btn_1"
                          type="submit">Tud o OK na compra</button></a>
                         
                          <a href="troca.html" class="d-flex">
                          <button class="button rounded-0 primary-bg text-white w-100 btn_1"
                          type="submit">Solicitar troca</button></a>

                          <a href="soldevolução.html">
                          <button class="button rounded-0 primary-bg text-white w-100 btn_1"
                          type="submit">Devolução</button></a>
