<%-- 
    ...
    Created on : 06/03/2020, 14:50:17
    Author     : simon
--%>
...
<body>
            ...
            <div class="billing_details">
                <div class="row">
                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control"
                                                    placeholder='Digite o que procura' onfocus="this.placeholder = ''"
                        ...
                        <form class="row contact_form" action="gerenciarprod.html" method="post"
                            novalidate="novalidate">
                            <div class="col-md-6 form-group p_star">
                                <input type="text" class="form-control" id="first" name="qtdprod" />
                            ...
                            <div>
                                ...
                                <form method="POST">
                                    <div class="col-lg-6">
                                        <div class="blog_right_sidebar">
                                            <aside class="single_sidebar_widget search_widget">
                                                <a href="gerenciarestoque.html" class="d-flex">
                                                    <button class="button rounded-0 primary-bg text-white w-100 btn_1"
                                                        type="submit">Incluir estoque</button>
                                                    <button class="button rounded-0 primary-bg text-white w-100 btn_1"
                                                    ...
                                                    <button class="button rounded-0 primary-bg text-white w-100 btn_1"
                                                        type="submit">Relatórios</button></a>
    ...
    <!--================End cadastro produto em estoque =================-->
                        ...
                        <div class="copyright_text">
                            <P>
                                ...
                                template is made with <i class="ti-heart" aria-hidden="true"></i> by <a
                                    href="https://colorlib.com" target="_blank">Colorlib and adapted for Simone</a>
                                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                            </P>
