<%-- 
    Document   : login
    Created on : 06/03/2020, 15:03:20
    Author     : simon
--%>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            <h2>Novo por aqui?</h2>
                            <p>Crie sua conta e aproveite nossas ofertas,
                                todos nossos itens são únicos, como todo bom artesanato.
                            </p>
                            <a href="cadastrocli.html" class="btn_3">Crie sua conta</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            <h3>Bem vindo! <br>
                                Por favor digite seus dados</h3>
                            <form class="row contact_form" action="perfilcli.html" method="post" novalidate="novalidate">
